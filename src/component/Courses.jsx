    ...
    return<>
       ...
       <div className="text-xl mt-4 md:mt-8  lg:text-3xl  ml-2 md:ml-10 text-center text-slate-100 text-shadow-2xs text-shadow-amber-50 ">
        ...
        <div className="flex justify-center w-full">
          <hr className="bg-orange-500 ml-2 md:ml-10 h-1 rounded-full w-20 lg:w-25 mt-2 mb-5  border-yellow-500 " />
        </div>
        ...
        
        {
          ...
          <div className='h-auto   place-self-center border-1  border-slate-400 m-1  w-65 rounded-xl shadow-2xl shadow-gray-600 hover:scale-[1.02] transition-all hover:border-2 '>
            ...
            <div className='h-auto text-xl pt-3  text-left px-4 rounded-b-xl font-semibold opacity-95'>
                ...
                <h2 className="my-2">₹. {list.price}</h2>
                <button className="h-8 text-sm  text-gray-900 font-semibold border-1 rounded border-black p-1 m-1 bg-gradient-to-l from-orange-500 to-orange-400 shadow-2xl shadow-white hover:border-yellow-100 active:scale-[0.9]" onClick={()=>navigate(list.buyLink)}>Buy now</button>
                </div>
                </div>
          </div>
          </ScrollReveal>)
