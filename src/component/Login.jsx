...
function Login() {
    return (
        ...
        <div className="h-[90vh] w-full px-5 flex justify-center items-center">
             <form className="max-w-96 w-full text-center border border-gray-300/60 rounded-2xl px-5 sm:px-8 bg-gradient-to-bl from-slate-950 to-slate-900 shadow-xl shadow-slate-600">
            ...
            <div className="mt-5 text-left text-indigo-500">
                <NavLink className="text-sm" to="#">Forgot password?</NavLink>
            </div>
            ...
            <p className="text-gray-200 text-sm mt-3 ">Don’t have an account? 
                <NavLink className="text-indigo-500 px-2" to="/sign-up">Sign up</NavLink></p>
